...
Domain analysis contract: evidence/runs/26d8e66f459cfe2d842504ad9d1a252962f7a0e7cffaa6a1b65e3d0ea5f44648/domain-analysis/domain-body-analysis.contract.v1.json
Rename plan: quality/domain-remediation/26d8e66f459cfe2d842504ad9d1a252962f7a0e7cffaa6a1b65e3d0ea5f44648/rename-plan.v1.json

Total candidates in this pass: 16
...
- read: readContract
- unclear-action: stubContentFor, capitalizesKebabSegment, jsStubContentFor, isUnimplementedStub, scaffold

### Proposed Action-Bearing Body Names

- ./read-contract/read-contract.js: readContract -- extract an action-bearing executable body around this method responsibility (declare the proposed file path in a file-system body contract before promotion)
- ./stub-content-for/stub-content-for.js: stubContentFor -- extract an action-bearing executable body around this method responsibility (declare the proposed file path in a file-system body contract before promotion)
- ./capitalizes-kebab-segment/capitalizes-kebab-segment.js: capitalizesKebabSegment -- extract an action-bearing executable body around this method responsibility (declare the proposed file path in a file-system body contract before promotion)
- ./js-stub-content-for/js-stub-content-for.js: jsStubContentFor -- extract an action-bearing executable body around this method responsibility (declare the proposed file path in a file-system body contract before promotion)
- ./is-unimplemented-stub/is-unimplemented-stub.js: isUnimplementedStub -- extract an action-bearing executable body around this method responsibility (declare the proposed file path in a file-system body contract before promotion)
- ./scaffold/scaffold.js: scaffold -- extract an action-bearing executable body around this method responsibility (declare the proposed file path in a file-system body contract before promotion)
...
existing tests for scaffold.js must continue to pass; add one test per proposed body covering its moved methods before promotion

### Rollback Notes

revert to scaffold.js and its original contract entry if any behavior-preserving test fails after the split

## src/blocks-path-only-body-contracts/blocks-path-only-body-contracts.js

### Current Responsibilities

- unclear-action: blocksPathOnlyBodyContracts, isPathOnlyEntry
- build: buildsBlockedEntryResult

### Proposed Action-Bearing Body Names

- src/blocks-path-only-body-contracts/blocks-path-only-body-contracts/blocks-path-only-body-contracts.js: blocksPathOnlyBodyContracts -- extract an action-bearing executable body around this method responsibility (declare the proposed file path in a file-system body contract before promotion)
- src/blocks-path-only-body-contracts/is-path-only-entry/is-path-only-entry.js: isPathOnlyEntry -- extract an action-bearing executable body around this method responsibility (declare the proposed file path in a file-system body contract before promotion)
- src/blocks-path-only-body-contracts/builds-blocked-entry-result/builds-blocked-entry-result.js: buildsBlockedEntryResult -- extract an action-bearing executable body around this method responsibility (declare the proposed file path in a file-system body contract before promotion)
...
existing tests for src/blocks-path-only-body-contracts/blocks-path-only-body-contracts.js must continue to pass; add one test per proposed body covering its moved methods before promotion

### Rollback Notes

revert to src/blocks-path-only-body-contracts/blocks-path-only-body-contracts.js and its original contract entry if any behavior-preserving test fails after the split

## src/blocks-unsupported-scenario-tieouts/blocks-unsupported-scenario-tieouts.js

### Current Responsibilities

- unclear-action: blocksUnsupportedScenarioTieOuts, isUnsupportedMapping
- build: buildsBlockedMappingResult

### Proposed Action-Bearing Body Names

- src/blocks-unsupported-scenario-tieouts/blocks-unsupported-scenario-tie-outs/blocks-unsupported-scenario-tie-outs.js: blocksUnsupportedScenarioTieOuts -- extract an action-bearing executable body around this method responsibility (declare the proposed file path in a file-system body contract before promotion)
- src/blocks-unsupported-scenario-tieouts/is-unsupported-mapping/is-unsupported-mapping.js: isUnsupportedMapping -- extract an action-bearing executable body around this method responsibility (declare the proposed file path in a file-system body contract before promotion)
- src/blocks-unsupported-scenario-tieouts/builds-blocked-mapping-result/builds-blocked-mapping-result.js: buildsBlockedMappingResult -- extract an action-bearing executable body around this method responsibility (declare the proposed file path in a file-system body contract before promotion)
...
existing tests for src/blocks-unsupported-scenario-tieouts/blocks-unsupported-scenario-tieouts.js must continue to pass; add one test per proposed body covering its moved methods before promotion

### Rollback Notes

revert to src/blocks-unsupported-scenario-tieouts/blocks-unsupported-scenario-tieouts.js and its original contract entry if any behavior-preserving test fails after the split

## src/challenges-worker-proposal/challenges-worker-proposal.js

### Current Responsibilities

- unclear-action: challengesScenarioTieOutProposal, challengesBodyContractPatch, challengesWaiverEntry, challengesRenamePlan, isGenericProposedName, challengesPackageExtractionPlan, countsSeverity
- build: buildsObjection, buildsPacketReview

### Proposed Action-Bearing Body Names

- src/challenges-worker-proposal/challenges-scenario-tie-out-proposal/challenges-scenario-tie-out-proposal.js: challengesScenarioTieOutProposal -- extract an action-bearing executable body around this method responsibility (declare the proposed file path in a file-system body contract before promotion)
- src/challenges-worker-proposal/challenges-body-contract-patch/challenges-body-contract-patch.js: challengesBodyContractPatch -- extract an action-bearing executable body around this method responsibility (declare the proposed file path in a file-system body contract before promotion)
- src/challenges-worker-proposal/challenges-waiver-entry/challenges-waiver-entry.js: challengesWaiverEntry -- extract an action-bearing executable body around this method responsibility (declare the proposed file path in a file-system body contract before promotion)
- src/challenges-worker-proposal/challenges-rename-plan/challenges-rename-plan.js: challengesRenamePlan -- extract an action-bearing executable body around this method responsibility (declare the proposed file path in a file-system body contract before promotion)
- src/challenges-worker-proposal/is-generic-proposed-name/is-generic-proposed-name.js: isGenericProposedName -- extract an action-bearing executable body around this method responsibility (declare the proposed file path in a file-system body contract before promotion)
- src/challenges-worker-proposal/challenges-package-extraction-plan/challenges-package-extraction-plan.js: challengesPackageExtractionPlan -- extract an action-bearing executable body around this method responsibility (declare the proposed file path in a file-system body contract before promotion)
- src/challenges-worker-proposal/builds-objection/builds-objection.js: buildsObjection -- extract an action-bearing executable body around this method responsibility (declare the proposed file path in a file-system body contract before promotion)
- src/challenges-worker-proposal/builds-packet-review/builds-packet-review.js: buildsPacketReview -- extract an action-bearing executable body around this method responsibility (declare the proposed file path in a file-system body contract before promotion)
- src/challenges-worker-proposal/counts-severity/counts-severity.js: countsSeverity -- extract an action-bearing executable body around this method responsibility (declare the proposed file path in a file-system body contract before promotion)
...
existing tests for src/challenges-worker-proposal/challenges-worker-proposal.js must continue to pass; add one test per proposed body covering its moved methods before promotion

### Rollback Notes

revert to src/challenges-worker-proposal/challenges-worker-proposal.js and its original contract entry if any behavior-preserving test fails after the split

## src/end-user-quality-evidence-bundle/end-user-quality-evidence-bundle.js

### Current Responsibilities

- unclear-action: formatsRepoRelativePath, hashesFile, redactsSecretText, indexesLatestQaByScenario, linksHumanReports, checksManifestHashes, mergesBlockerCodes, deduplicatesCodes, countsFailedQaScenarios, countsWaivedQaScenarios
...
- read: readsFeatureFiles, readsGitValue, readsBundleManifests, readsDirectoryPaths, readsScenarioKey, readsLinkedReportSourcePaths
...
- unclear-action: slugifies, selectsScenarioProofStatus, eventMatchesNode, sortsEventsByTimeAndStep, formatsSourceLineRange, sumsNumbers, findsReceiptPathsForNode, findsSlowestNode, countsNodesWithObservedTelemetry, countsNodesWithObservedReceipts, indexesSlisByName, evaluatesSingleServiceLevelObjective, evaluatesServiceLevelObjectives, formatsValue, formatsRepoRelativePath, formatsProofPathForReport, formatsSourcePathWithLineRange, escapesCsv, projectsFeatureExecutionProofToCsv, indexesSloEvaluationsById, checksFeatureReportTruthGate, checksUnsupportedSlaClaims
- read: readsLines, readsMilliseconds, readsEventTimestamp, readsTelemetryEventIdsForMethod, readsReceiptPathsForMethod, readsTelemetryEventIds, readsTelemetryEventPaths, readsObservedCalls, readsCallDurations, readsElapsedBetweenNodes, readsMethodCalls, readsBlockerFindingCode, readsNodeBlockerCodes, readsTelemetrySourcePaths, readsFirstBlockerCode, readsRuntimeStep, readsSupportingEvaluations
...
- normalize: normalizesDeclaredNode, normalizesDeclaredNodes
...
- call: summarizesCalls, findsSlowestMethodCall, countsObservedCalls, stampsMethodCallOwnership
...
- unclear-action: recordsAuditTestimony, formatsRepoRelativePath, hashesText, hashesFile, sortsFeatureSpecsById, indexesLatestQaBundleByFeature, selectsDisplayStatus, appliesStaleReasonsFromPreviousContract, isPassingDisplayStatus, formatsSentinelPathForFinding, removesObsoleteStatusSentinels, countsByDisplayStatus, sortsBoardRowsByProductUrgency, sortsBlockerSummaryByFrequency
- read: readsJsonFile, readsGitValue, readsDirectoryPaths, readsQaBundleRecords, readsExecutionProofRecords, readsQaStatus, readsFindingCode, readsPreviousStatusContract, readsTopBlockerCode
...
- unclear-action: formatsRepoRelativePath, redactsSensitiveText, hashesFile, requiresField, isPathInsideAllowedPath, checksLlmTestingAction, checksRequiredHumanReports
...
- read: readsTextFile, readsAcceptanceSourceSlice, readsBoundedReportContent, readsUserFacingMarkdownReportPaths, readsReviewedMarkdownReports, readsReviewedHtmlPreviewRecords, readsAcceptanceCriteriaByStatus, readsAcceptanceCriteriaOutsideStatus, readsRequiredReportPaths, readsFormattedRequiredReportPaths, readsReportArtifactIndexMarkdownPaths, readsReviewedHtmlPreviewPaths, readsScreenshotIndexRecords, readsStakeholderNotificationDraftPath, readsSessionSurfaceSummary, readsArtifactsBeforeManifest
...
- normalize: normalizesPathForComparison
...
- unclear-action: mapsDomainBodyResponsibilities, indexesSprawlEntriesByPath
- resolve: resolvesSourceRunId, resolvesFileClassification, resolvesPrimaryResponsibility, resolvesWaiverClassCandidate, resolvesClassificationReason
- classify: classifiesSourceFile
- build: buildsDomainMapSummary

### Proposed Action-Bearing Body Names

- src/maps-domain-body-responsibilities/maps-domain-body-responsibilities/maps-domain-body-responsibilities.js: mapsDomainBodyResponsibilities -- extract an action-bearing executable body around this method responsibility (declare the proposed file path in a file-system body contract before promotion)
- src/maps-domain-body-responsibilities/resolves-source-run-id/resolves-source-run-id.js: resolvesSourceRunId -- extract an action-bearing executable body around this method responsibility (declare the proposed file path in a file-system body contract before promotion)
- src/maps-domain-body-responsibilities/indexes-sprawl-entries-by-path/indexes-sprawl-entries-by-path.js: indexesSprawlEntriesByPath -- extract an action-bearing executable body around this method responsibility (declare the proposed file path in a file-system body contract before promotion)
- src/maps-domain-body-responsibilities/classifies-source-file/classifies-source-file.js: classifiesSourceFile -- extract an action-bearing executable body around this method responsibility (declare the proposed file path in a file-system body contract before promotion)
- src/maps-domain-body-responsibilities/resolves-file-classification/resolves-file-classification.js: resolvesFileClassification -- extract an action-bearing executable body around this method responsibility (declare the proposed file path in a file-system body contract before promotion)
- src/maps-domain-body-responsibilities/resolves-primary-responsibility/resolves-primary-responsibility.js: resolvesPrimaryResponsibility -- extract an action-bearing executable body around this method responsibility (declare the proposed file path in a file-system body contract before promotion)
- src/maps-domain-body-responsibilities/resolves-waiver-class-candidate/resolves-waiver-class-candidate.js: resolvesWaiverClassCandidate -- extract an action-bearing executable body around this method responsibility (declare the proposed file path in a file-system body contract before promotion)
- src/maps-domain-body-responsibilities/resolves-classification-reason/resolves-classification-reason.js: resolvesClassificationReason -- extract an action-bearing executable body around this method responsibility (declare the proposed file path in a file-system body contract before promotion)
- src/maps-domain-body-responsibilities/builds-domain-map-summary/builds-domain-map-summary.js: buildsDomainMapSummary -- extract an action-bearing executable body around this method responsibility (declare the proposed file path in a file-system body contract before promotion)
...
existing tests for src/maps-domain-body-responsibilities/maps-domain-body-responsibilities.js must continue to pass; add one test per proposed body covering its moved methods before promotion

### Rollback Notes

revert to src/maps-domain-body-responsibilities/maps-domain-body-responsibilities.js and its original contract entry if any behavior-preserving test fails after the split
...
- unclear-action: plansRemediationBacklog, recordsFindingPath
- resolve: resolvesSourceRunId, resolvesRunScopedPaths, resolvesRunScopedPath
- collect: collectsFindingPathsByCode
- build: buildsBacklogItem

### Proposed Action-Bearing Body Names

- src/plans-remediation-backlog/plans-remediation-backlog/plans-remediation-backlog.js: plansRemediationBacklog -- extract an action-bearing executable body around this method responsibility (declare the proposed file path in a file-system body contract before promotion)
- src/plans-remediation-backlog/resolves-source-run-id/resolves-source-run-id.js: resolvesSourceRunId -- extract an action-bearing executable body around this method responsibility (declare the proposed file path in a file-system body contract before promotion)
- src/plans-remediation-backlog/collects-finding-paths-by-code/collects-finding-paths-by-code.js: collectsFindingPathsByCode -- extract an action-bearing executable body around this method responsibility (declare the proposed file path in a file-system body contract before promotion)
- src/plans-remediation-backlog/records-finding-path/records-finding-path.js: recordsFindingPath -- extract an action-bearing executable body around this method responsibility (declare the proposed file path in a file-system body contract before promotion)
- src/plans-remediation-backlog/builds-backlog-item/builds-backlog-item.js: buildsBacklogItem -- extract an action-bearing executable body around this method responsibility (declare the proposed file path in a file-system body contract before promotion)
- src/plans-remediation-backlog/resolves-run-scoped-paths/resolves-run-scoped-paths.js: resolvesRunScopedPaths -- extract an action-bearing executable body around this method responsibility (declare the proposed file path in a file-system body contract before promotion)
- src/plans-remediation-backlog/resolves-run-scoped-path/resolves-run-scoped-path.js: resolvesRunScopedPath -- extract an action-bearing executable body around this method responsibility (declare the proposed file path in a file-system body contract before promotion)
...
existing tests for src/plans-remediation-backlog/plans-remediation-backlog.js must continue to pass; add one test per proposed body covering its moved methods before promotion

### Rollback Notes

revert to src/plans-remediation-backlog/plans-remediation-backlog.js and its original contract entry if any behavior-preserving test fails after the split

## src/promotes-body-contract-patch/promotes-body-contract-patch.js

### Current Responsibilities

- unclear-action: promotesBodyContractPatch, selectsPromotableEntries, selectsSkippedEntries, appliesEntriesToContract, addsOwnedRuntimeEntry, clonesContract
- build: buildsDeclaredBodyEntry
- read: readsPath

### Proposed Action-Bearing Body Names

- src/promotes-body-contract-patch/promotes-body-contract-patch/promotes-body-contract-patch.js: promotesBodyContractPatch -- extract an action-bearing executable body around this method responsibility (declare the proposed file path in a file-system body contract before promotion)
- src/promotes-body-contract-patch/selects-promotable-entries/selects-promotable-entries.js: selectsPromotableEntries -- extract an action-bearing executable body around this method responsibility (declare the proposed file path in a file-system body contract before promotion)
- src/promotes-body-contract-patch/selects-skipped-entries/selects-skipped-entries.js: selectsSkippedEntries -- extract an action-bearing executable body around this method responsibility (declare the proposed file path in a file-system body contract before promotion)
- src/promotes-body-contract-patch/applies-entries-to-contract/applies-entries-to-contract.js: appliesEntriesToContract -- extract an action-bearing executable body around this method responsibility (declare the proposed file path in a file-system body contract before promotion)
- src/promotes-body-contract-patch/adds-owned-runtime-entry/adds-owned-runtime-entry.js: addsOwnedRuntimeEntry -- extract an action-bearing executable body around this method responsibility (declare the proposed file path in a file-system body contract before promotion)
- src/promotes-body-contract-patch/builds-declared-body-entry/builds-declared-body-entry.js: buildsDeclaredBodyEntry -- extract an action-bearing executable body around this method responsibility (declare the proposed file path in a file-system body contract before promotion)
- src/promotes-body-contract-patch/clones-contract/clones-contract.js: clonesContract -- extract an action-bearing executable body around this method responsibility (declare the proposed file path in a file-system body contract before promotion)
- src/promotes-body-contract-patch/reads-path/reads-path.js: readsPath -- extract an action-bearing executable body around this method responsibility (declare the proposed file path in a file-system body contract before promotion)
...
existing tests for src/promotes-body-contract-patch/promotes-body-contract-patch.js must continue to pass; add one test per proposed body covering its moved methods before promotion

### Rollback Notes

revert to src/promotes-body-contract-patch/promotes-body-contract-patch.js and its original contract entry if any behavior-preserving test fails after the split

## src/report-provenance/report-provenance.js

### Current Responsibilities

- unclear-action: stableStringify, stringifiesStableValue, stringifiesObjectEntry, sha256Hex, canonicalizeConfig, canonicalizeMethods, canonicalizesMethod, computesConfigHash, formatsCommandLine, formatsCommandLineSegment, trimsProvenanceLine, isTruthyLine, checksReportTruthGate
- inventory: computesSourceInventoryHash
- read: readsGitWorkingTreeMarker, readsReportProvenance
...
- unclear-action: sha256Hex, suppressTelemetryDuring, trimsLine, derivesExpectedVerdict, isMarkdownTableRow, isMarkdownHeaderRow, isMarkdownSeparatorRow, splitsMarkdownTableRow, addsBlocker, formatsReportTruthSummary
- read: readsMarkdownSection, readsReportSummary, readsMarkdownFindings, readsMarkdownMethodTable, readsFirstMarkdownSectionBody
- parse: parsesSummaryLine, parsesIntegerField, parsesCoverageField, parsesFindingBlock
- filter: filtersLanguageFinding
