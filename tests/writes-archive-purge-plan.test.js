...
test('writesArchivePurgePlan writes plan JSON and report and never deletes a file', () => {
  ...
  try {
    ...
    fs.writeFileSync(path.join(tempDir, 'evidence/archive/2026/run-1/notes.md'), 'notes', 'utf8');

    const archivedRun = { runId: 'run-1', year: '2026', archivedAt: '2025-01-01T00:00:00.000Z', hasManifest: true, totalByteSize: 100, artifactCount: 1 };
